...
- **For complex patterns**: SVM (RBF kernel) or MLP
...
- MLP (neural network): ~2-10 minutes
...
**Principle**: Feedforward neural network
...
hidden_layer_sizes: Network architecture 
  ...
  - (200, 100, 50): Three layers
  
activation: Activation function ('relu', 'tanh', default: 'relu')
learning_rate_init: Initial learning rate (0.001 - 0.01, default: 0.001)
alpha: L2 regularization (0.0001 - 0.01, default: 0.0001)
max_iter: Maximum iterations (100 - 1000, default: 200)
```

**When to use**:
- Large datasets (>1000 samples)
- After trying simpler methods
...
| **MLP**                 | ⚡     | ⭐⭐⭐      | ⭐                | ⚙️⚙️⚙️⚙️            | Large datasets, complex patterns |
