...
:::{grid-item-card} 🔬 Analysis Methods
:link: analysis-methods/index
:link-type: doc
...
- **Email**: [@zerozedsc](https://github.com/zerozedsc)

## 📄 License

This project is licensed under the MIT License. See the [LICENSE](https://github.com/zerozedsc/Raman-Spectroscopy-Analysis-Application/blob/main/LICENSE) file for details.
