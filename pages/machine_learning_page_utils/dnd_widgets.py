...
class GroupDropList(QListWidget):
	...
	def _notify_parent_changed(self):
		"""Notify the owning MachineLearningPage to persist changes."""
		try:
			parent = self.parent()
			# The QListWidget is embedded inside a tab page -> walk up a bit.
	...
	def add_dataset(self, name: str) -> bool:
		...
		# Build an item widget with a delete button (DataPackagePage-style)
		w = QWidget()
		row = QHBoxLayout(w)
