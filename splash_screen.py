...
class SplashScreen(QSplashScreen):
    ...
    def drawContents(self, painter):
        ...
        # Background
        painter.fillRect(bar_x, bar_y, bar_width, bar_height, QColor(100, 100, 100, 180))
        
        # Progress fill
        progress_width = int((bar_width * self.progress_value) / 100)
        painter.fillRect(bar_x, bar_y, progress_width, bar_height, QColor(76, 175, 80, 255))  # Green
