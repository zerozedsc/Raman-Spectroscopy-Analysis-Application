                ...
                "Cropper": {
                    ...
                    "param_info": {
                        "region": {
                            "type": "tuple",
                            "range": [(0, 4500)],
                            "description": "Wavenumber range to extract (start, end, in cm⁻¹)",
                        }
                    },
        ...
        return {
            ...
            "IASLS": {
                ...
                "param_info": {
                    ...
                    "p_initial": {
                        ...
                        "range": [0.001, 0.999],
                        "step": 0.001,
                        "description": "Asymmetry parameter (alias for p)",
                    },
                    "lam_1": {
                        "type": "scientific",
                        "range": [1e-6, 1e-2],
                ...
                "param_aliases": {
                    "p_initial": "p"
                },  # Accept 'p_initial' as alias for 'p'
            ...
            "ARPLS": {
                ...
                "param_info": {
                    "lam": {
                        "type": "scientific",
                        "range": [1e2, 1e12],
                        "description": "Smoothing parameter (λ, typical: 1e4-1e7)",
                    },
                    "diff_order": {
                        "type": "int",
                        "range": [1, 3],
                    ...
                    "tol": {
                        "type": "scientific",
                        "range": [1e-9, 1e-1],
                        "description": "Convergence tolerance (ratio)",
                    },
                },
            ...
            "ASPLS": {
                ...
                "param_info": {
                    ...
                    "alpha": {
                        "type": "optional",
                        "description": "Array of values controlling local lam (optional, for advanced users)",
                    },
                },
            ...
            "FABC": {
                ...
                "param_info": {
                    ...
                    "scale": {
                        ...
                        "range": [0.1, 5.0],
                        "step": 0.1,
                        "description": "Scale parameter for noise estimation",
                        "optional": True,
                    },
                    "num_std": {
                        "type": "float",
                        "range": [1.0, 10.0],
                        "step": 0.5,
                        "description": "Number of standard deviations for thresholding",
                    },
                    "diff_order": {
                        "type": "int",
                        "range": [1, 3],
                        "description": "Order of differential matrix",
                    },
                    "min_length": {
                        "type": "int",
                        "range": [1, 10],
                        "description": "Minimum length for smoothing",
                    },
                    "weights": {
                        "type": "array",
                        "description": "Optional weight array",
                        "optional": True,
                    },
                    "weights_as_mask": {
                        "type": "bool",
                        "description": "Treat weights as binary mask",
                    },
                    "x_data": {
                        "type": "array",
                        "description": "X-axis data (provided automatically from spectral_axis)",
                        "optional": True,
                        "internal": True,
                    },
                },
                ...
                "MedianDespike": {
                    ...
                    "param_info": {
                        ...
                        "max_iter": {
                            "type": "int",
                            "range": [1, 10],
                            "description": "Iterations for removing clustered spikes",
                        },
                    },
                ...
                "ButterworthHighPass": {
                    ...
                    "param_info": {
                        "cutoff_freq": {
                            ...
                            "range": [0.001, 0.4],
                            "step": 0.001,
                            "description": "Normalized cutoff frequency (0 < fc < 0.5)",
                        },
                        "filter_order": {
                            "type": "int",
                            "range": [1, 6],
                        ...
                        "validate_peaks": {
                            "type": "bool",
                            "description": "Warn if peak areas change significantly",
                        },
                    },
                ...
                "Derivative": {
                    ...
                    "param_info": {
                        ...
                        "window_length": {
                            ...
                            "range": [3, 51],
                            "step": 2,
                            "description": "Savitzky-Golay window length (odd, larger = smoother)",
                        },
                        "polyorder": {
                            "type": "int",
                            "range": [1, 10],
                            "description": "Polynomial order (must be < window_length)",
                        },
                    },
            ...
            "denoising": {
                ...
                "GaussianSmoothing": {
                    ...
                    "param_info": {
                        "kernel": {
                            ...
                            "range": [1, 21],
                            "step": 2,
                            "description": "Gaussian kernel sigma (larger = more smoothing)",
                        },
                        "threshold": {
                            "type": "float",
                            "range": [5.0, 20.0],
                            "step": 0.5,
                            "description": "Detection threshold (set high for pure smoothing)",
                        },
                    },
                ...
                "SavGolSmoothing": {
                    ...
                    "param_info": {
                        "window_length": {
                            ...
                            "range": [3, 51],
                            "step": 2,
                            "description": "Window length (must be odd, larger = more smoothing)",
                        },
                        "polyorder": {
                            "type": "int",
                            "range": [1, 10],
                ...
                "MeanCentering": {
                    ...
                    "param_info": {
                        "per_feature": {
                            "type": "bool",
                            "description": "If True, center by mean across samples per wavenumber. If False, center each spectrum by its own mean.",
                        }
                    },
                ...
                "QuantileNormalization": {
                    ...
                    "param_info": {
                        "method": {
                            ...
                            "choices": ["median", "mean"],
                            "default": "median",
                            "description": "Aggregation method for reference quantiles",
                        }
                    },
                ...
                "RankTransform": {
                    ...
                    "param_info": {
                        "scale_range": {
                            "type": "tuple",
                            "range": [(-1, 1)],
                            "description": "Target range for scaled ranks (min, max)",
                        },
                        "standardize": {
                            "type": "bool",
                            "description": "Standardize features after ranking",
                        },
                    },
                ...
                "PeakRatioFeatures": {
                    ...
                    "param_info": {
                        "window_size": {
                            ...
                            "range": [5.0, 50.0],
                            "step": 1.0,
                            "description": "Half-width of window around peak (cm⁻¹)",
                        },
                        "extraction_method": {
                            "type": "choice",
                            "choices": ["local_max", "local_integral", "gaussian_fit"],
                            "default": "local_max",
                            "description": "Method for extracting peak intensity",
                        },
                        "ratio_mode": {
                            "type": "choice",
                            "choices": ["simple", "log", "both"],
                            "default": "log",
                            "description": "Type of ratios to compute",
                        },
                        "epsilon": {
                            "type": "scientific",
                            "range": [1e-12, 1e-6],
            ...
            custom_methods["denoising"]["ConvolutionalAutoencoder"] = {
                ...
                "param_info": {
                    "latent_dim": {
                        "type": "int",
                        "range": [8, 128],
                        "description": "Latent space dimensionality (16-32 typical)",
                    },
                    "tv_weight": {
                        "type": "float",
                        "range": [0.0, 0.1],
                        "step": 0.001,
                        "description": "Total variation regularization weight",
                    },
                },
            ...
            for key, value in params.items():
                ...
                if param_type == "int":
                    ...
                    if value is None:
                        ...
                        converted_params[actual_key] = int(
                            float(value)
                        )  # float() handles strings, int() converts to int
                    ...
                    if isinstance(value, bool):
                        ...
                        converted_params[actual_key] = value.lower() in (
                            "true",
                            "1",
                            "yes",
                        )
